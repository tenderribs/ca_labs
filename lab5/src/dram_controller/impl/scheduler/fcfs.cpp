...
class FCFSImpl : public IScheduler, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IScheduler, FCFSImpl, "FCFS", "FCFS DRAM Scheduler.")
  private:
    IDRAM* m_dram;
  ...
  public:
    ...
    ReqBuffer::iterator compare(ReqBuffer::iterator req1, ReqBuffer::iterator req2) override {
      ...
      // comment out first ready (FR) part
      // if (ready1 ^ ready2) {
      //   if (ready1) {
      //     return req1;
      //   } else {
